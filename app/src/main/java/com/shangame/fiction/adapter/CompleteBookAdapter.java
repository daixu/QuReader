...
public class CompleteBookAdapter extends BaseQuickAdapter<BookInfoEntity, BaseViewHolder> {
    public CompleteBookAdapter(int layoutResId, @Nullable List<BookInfoEntity> data) {

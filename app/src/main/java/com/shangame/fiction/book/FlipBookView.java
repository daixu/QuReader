...
public class FlipBookView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceChanged(GL10 gl10, int width, int height) {
        try {
            ...
            mPageRender.setActivity(mActivity);
            ...
            mPageRender.setOnOpenVideoRegionClickListener1(onOpenVideoRegionClickListener1);
...
//            Log.i(TAG, "onFingerUp: 111");
    ...
    public void setOnOpenVideoRegionClickListener1(View.OnClickListener onOpenVideoRegionClickListener) {
        this.onOpenVideoRegionClickListener1 = onOpenVideoRegionClickListener;

...
public class BookMenuFragmentPagerAdapter extends FragmentPagerAdapter {
    ...
    public void setOnBookMarkCheckedLinstener(OnBookMarkCheckedListener onBookMarkCheckedListener) {
        bookMarkFragment.setOnBookMarkCheckedListener(onBookMarkCheckedListener);
    }
}
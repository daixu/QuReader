...
public class FilteBookActivity extends BaseActivity implements View.OnClickListener, BookFilterContacts.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filterViewAll = findViewById(R.id.filterViewAll);
        filterViewAll.setSelected(true);

        filterView1 = findViewById(R.id.filterView1);
        filterView2 = findViewById(R.id.filterView2);
        filterView3 = findViewById(R.id.filterView3);
        filterView4 = findViewById(R.id.filterView4);
        filterView5 = findViewById(R.id.filterView5);
        filterView6 = findViewById(R.id.filterView6);
        filterView7 = findViewById(R.id.filterView7);
        filterView8 = findViewById(R.id.filterView8);

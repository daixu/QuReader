...
public class MusicPlayerService extends Service implements IPlayback, IPlayback.Callback, MusicPlayerContract.View {
    ...
    private static final String ACTION_PLAY_TOGGLE = "com.fiction.bar1.listen.book.ACTION.PLAY_TOGGLE";
    private static final String ACTION_PLAY_LAST = "com.fiction.bar1.listen.book.ACTION.PLAY_LAST";
    private static final String ACTION_PLAY_NEXT = "com.fiction.bar1.listen.book.ACTION.PLAY_NEXT";
    private static final String ACTION_STOP_SERVICE = "com.fiction.bar1.listen.book.ACTION.STOP_SERVICE";

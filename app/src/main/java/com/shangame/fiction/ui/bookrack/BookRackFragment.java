...
public class BookRackFragment extends BaseFragment implements View.OnClickListener {
    ...
    private static final int START_FILER_ACTIVITY_REQUEST_CODE = 660;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == START_FILER_ACTIVITY_REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                bookListFragment.setFilterParam(statusId, readeCid, numCid, maleCid);
    ...
    private void initMagicIndicator(View contentView) {
        ...
        BigMagicIndicatorAdapter bigMagicIndicatorAdapter = new BigMagicIndicatorAdapter(mContext, mViewPager, ContextCompat.getColor(mContext, R.color.white));
    ...
    public void onClick(final View view) {
        switch (view.getId()) {
            case R.id.ivFilter:
                ...
                startActivityForResult(intent, START_FILER_ACTIVITY_REQUEST_CODE);
                break;
            case R.id.ivSearch:
